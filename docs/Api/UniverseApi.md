...
# **postUniverseIds**
> \Swagger\Client\Model\PostUniverseIdsOk postUniverseIds($body, $accept_language, $datasource, $language)
...
# **postUniverseNames**
> \Swagger\Client\Model\PostUniverseNames200Ok[] postUniverseNames($body, $datasource)
