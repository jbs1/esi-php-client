...
class KillmailsApi
{
    ...
    public function getCorporationsCorporationIdKillmailsRecentWithHttpInfo($corporation_id, $datasource = null, $max_kill_id = null, $token = null, $user_agent = null, $x_user_agent = null)
    {
        ...
        try {
            ...
            return [$this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\GetCorporationsCorporationIdKillmailsRecent200Ok[]', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
