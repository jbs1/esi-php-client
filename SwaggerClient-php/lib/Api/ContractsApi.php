...
class ContractsApi
{
     ...
     */
    public function getCorporationsCorporationIdContracts($corporation_id, $datasource = null, $token = null, $user_agent = null, $x_user_agent = null)
    {
     ...
     */
    public function getCorporationsCorporationIdContractsWithHttpInfo($corporation_id, $datasource = null, $token = null, $user_agent = null, $x_user_agent = null)
    {
        ...
        try {
            ...
            return [$this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\GetCorporationsCorporationIdContracts200Ok[]', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
    ...
    public function getCorporationsCorporationIdContractsContractIdBidsWithHttpInfo($contract_id, $corporation_id, $datasource = null, $page = null, $token = null, $user_agent = null, $x_user_agent = null)
    {
        ...
        try {
            ...
            return [$this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\GetCorporationsCorporationIdContractsContractIdBids200Ok[]', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
    ...
    public function getCorporationsCorporationIdContractsContractIdItemsWithHttpInfo($contract_id, $corporation_id, $datasource = null, $token = null, $user_agent = null, $x_user_agent = null)
    {
        ...
        try {
            ...
            return [$this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\GetCorporationsCorporationIdContractsContractIdItems200Ok[]', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
