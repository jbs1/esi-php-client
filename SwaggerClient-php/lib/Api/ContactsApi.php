...
class ContactsApi
{
    ...
    protected function deleteCharactersCharacterIdContactsRequest($character_id, $contact_ids, $datasource = 'tranquility', $token = null, $user_agent = null, $x_user_agent = null)
    {
        ...
        if (count($contact_ids) > 100) {
            throw new \InvalidArgumentException('invalid value for "$contact_ids" when calling ContactsApi.deleteCharactersCharacterIdContacts, number of items must be less than or equal to 100.');
        }
