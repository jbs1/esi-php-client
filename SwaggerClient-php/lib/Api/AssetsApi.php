...
class AssetsApi
{
    ...
    public function getCorporationsCorporationIdAssetsWithHttpInfo($corporation_id, $datasource = null, $page = null, $token = null, $user_agent = null, $x_user_agent = null)
    {
        ...
        try {
            ...
            return [$this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\GetCorporationsCorporationIdAssets200Ok[]', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
    ...
    public function postCharactersCharacterIdAssetsLocationsWithHttpInfo($character_id, $item_ids, $datasource = null, $token = null, $user_agent = null, $x_user_agent = null)
    {
        ...
        try {
            ...
            return [$this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\PostCharactersCharacterIdAssetsLocations200Ok[]', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
    ...
    public function postCharactersCharacterIdAssetsNamesWithHttpInfo($character_id, $item_ids, $datasource = null, $token = null, $user_agent = null, $x_user_agent = null)
    {
        ...
        try {
            ...
            return [$this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\PostCharactersCharacterIdAssetsNames200Ok[]', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
    ...
    public function postCorporationsCorporationIdAssetsLocationsWithHttpInfo($corporation_id, $item_ids, $datasource = null, $token = null, $user_agent = null, $x_user_agent = null)
    {
        ...
        try {
            ...
            return [$this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\PostCorporationsCorporationIdAssetsLocations200Ok[]', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
    ...
    public function postCorporationsCorporationIdAssetsNamesWithHttpInfo($corporation_id, $item_ids, $datasource = null, $token = null, $user_agent = null, $x_user_agent = null)
    {
        ...
        try {
            ...
            return [$this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\PostCorporationsCorporationIdAssetsNames200Ok[]', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
