...
class IndustryApi
{
    ...
    public function getCharactersCharacterIdIndustryJobsWithHttpInfo($character_id, $datasource = null, $include_completed = null, $token = null, $user_agent = null, $x_user_agent = null)
    {
        ...
        try {
            ...
            return [$this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\GetCharactersCharacterIdIndustryJobs200Ok[]', $httpHeader), $statusCode, $httpHeader];
    ...
    public function getCorporationsCorporationIdIndustryJobsWithHttpInfo($corporation_id, $datasource = null, $include_completed = null, $page = null, $token = null, $user_agent = null, $x_user_agent = null)
    {
        ...
        try {
            ...
            return [$this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\GetCorporationsCorporationIdIndustryJobs200Ok[]', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
