...
class GetCorporationsCorporationIdOrders200Ok implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!in_array($this->container['range'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'range', must be one of '1', '10', '2', '20', '3', '30', '4', '40', '5', 'region', 'solarsystem', 'station'.";
        }
        ...
        if (!in_array($this->container['state'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'state', must be one of 'cancelled', 'character_deleted', 'closed', 'expired', 'open', 'pending'.";
        }
        ...
        if (($this->container['wallet_division'] > 7)) {
            $invalid_properties[] = "invalid value for 'wallet_division', must be smaller than or equal to 7.";
        }

        if (($this->container['wallet_division'] < 1)) {
            $invalid_properties[] = "invalid value for 'wallet_division', must be bigger than or equal to 1.";
        }
