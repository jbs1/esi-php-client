...
class GetCorporationsCorporationIdBlueprints200Ok implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!in_array($this->container['location_flag'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'location_flag', must be one of 'AssetSafety', 'AutoFit', 'Bonus', 'Booster', 'BoosterBay', 'Capsule', 'Cargo', 'CorpDeliveries', 'CorpSAG1', 'CorpSAG2', 'CorpSAG3', 'CorpSAG4', 'CorpSAG5', 'CorpSAG6', 'CorpSAG7', 'CrateLoot', 'Deliveries', 'DroneBay', 'DustBattle', 'DustDatabank', 'FighterBay', 'FighterTube0', 'FighterTube1', 'FighterTube2', 'FighterTube3', 'FighterTube4', 'FleetHangar', 'Hangar', 'HangarAll', 'HiSlot0', 'HiSlot1', 'HiSlot2', 'HiSlot3', 'HiSlot4', 'HiSlot5', 'HiSlot6', 'HiSlot7', 'HiddenModifers', 'Implant', 'Impounded', 'JunkyardReprocessed', 'JunkyardTrashed', 'LoSlot0', 'LoSlot1', 'LoSlot2', 'LoSlot3', 'LoSlot4', 'LoSlot5', 'LoSlot6', 'LoSlot7', 'Locked', 'MedSlot0', 'MedSlot1', 'MedSlot2', 'MedSlot3', 'MedSlot4', 'MedSlot5', 'MedSlot6', 'MedSlot7', 'OfficeFolder', 'Pilot', 'PlanetSurface', 'QuafeBay', 'Reward', 'RigSlot0', 'RigSlot1', 'RigSlot2', 'RigSlot3', 'RigSlot4', 'RigSlot5', 'RigSlot6', 'RigSlot7', 'SecondaryStorage', 'ServiceSlot0', 'ServiceSlot1', 'ServiceSlot2', 'ServiceSlot3', 'ServiceSlot4', 'ServiceSlot5', 'ServiceSlot6', 'ServiceSlot7', 'ShipHangar', 'ShipOffline', 'Skill', 'SkillInTraining', 'SpecializedAmmoHold', 'SpecializedCommandCenterHold', 'SpecializedFuelBay', 'SpecializedGasHold', 'SpecializedIndustrialShipHold', 'SpecializedLargeShipHold', 'SpecializedMaterialBay', 'SpecializedMediumShipHold', 'SpecializedMineralHold', 'SpecializedOreHold', 'SpecializedPlanetaryCommoditiesHold', 'SpecializedSalvageHold', 'SpecializedShipHold', 'SpecializedSmallShipHold', 'StructureActive', 'StructureFuel', 'StructureInactive', 'StructureOffline', 'SubSystemSlot0', 'SubSystemSlot1', 'SubSystemSlot2', 'SubSystemSlot3', 'SubSystemSlot4', 'SubSystemSlot5', 'SubSystemSlot6', 'SubSystemSlot7', 'SubsystemBay', 'Unlocked', 'Wallet', 'Wardrobe'.";
        }
        ...
        if (($this->container['material_efficiency'] > 10)) {
            $invalid_properties[] = "invalid value for 'material_efficiency', must be smaller than or equal to 10.";
        }

        if (($this->container['material_efficiency'] < 0)) {
            $invalid_properties[] = "invalid value for 'material_efficiency', must be bigger than or equal to 0.";
        }
        ...
        if (($this->container['quantity'] < -2)) {
            $invalid_properties[] = "invalid value for 'quantity', must be bigger than or equal to -2.";
        }
        ...
        if (($this->container['runs'] < -1)) {
            $invalid_properties[] = "invalid value for 'runs', must be bigger than or equal to -1.";
        }
        ...
        if (($this->container['time_efficiency'] > 20)) {
            $invalid_properties[] = "invalid value for 'time_efficiency', must be smaller than or equal to 20.";
        }

        if (($this->container['time_efficiency'] < 0)) {
            $invalid_properties[] = "invalid value for 'time_efficiency', must be bigger than or equal to 0.";
        }
