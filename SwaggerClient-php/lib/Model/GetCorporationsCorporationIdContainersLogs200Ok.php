...
class GetCorporationsCorporationIdContainersLogs200Ok implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!in_array($this->container['action'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'action', must be one of 'add', 'assemble', 'configure', 'enter_password', 'lock', 'move', 'repackage', 'set_name', 'set_password', 'unlock'.";
        }
        ...
        if (!in_array($this->container['password_type'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'password_type', must be one of 'config', 'general'.";
        }
    ...
    public function setPasswordType($password_type)
    {
        ...
        if (!is_null($password_type) && (!in_array($password_type, $allowed_values))) {
