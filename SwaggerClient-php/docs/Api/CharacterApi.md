...
Returns aggregate yearly stats for a character  --- Alternate route: `/legacy/characters/{character_id}/stats/`  Alternate route: `/v1/characters/{character_id}/stats/`  --- This route is cached for up to 86400 seconds  --- [This route has an available update](https://esi.tech.ccp.is/diff/latest/dev/#GET-/characters/{character_id}/stats/)
