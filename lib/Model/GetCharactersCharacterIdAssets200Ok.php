...
class GetCharactersCharacterIdAssets200Ok implements ModelInterface, ArrayAccess
{
    ...
    const LOCATION_FLAG_CORPORATION_GOAL_DELIVERIES = 'CorporationGoalDeliveries';
    ...
    const LOCATION_FLAG_MOBILE_DEPOT_HOLD = 'MobileDepotHold';
    ...
    const LOCATION_FLAG_SPECIALIZED_ASTEROID_HOLD = 'SpecializedAsteroidHold';
    ...
    const LOCATION_FLAG_SPECIALIZED_ICE_HOLD = 'SpecializedIceHold';
    ...
    const LOCATION_FLAG_STRUCTURE_DEED_BAY = 'StructureDeedBay';
