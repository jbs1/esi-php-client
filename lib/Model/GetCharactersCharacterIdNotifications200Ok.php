...
class GetCharactersCharacterIdNotifications200Ok implements ModelInterface, ArrayAccess
{
    ...
    const TYPE_CORPORATION_GOAL_CLOSED = 'CorporationGoalClosed';
    const TYPE_CORPORATION_GOAL_COMPLETED = 'CorporationGoalCompleted';
    const TYPE_CORPORATION_GOAL_CREATED = 'CorporationGoalCreated';
    const TYPE_CORPORATION_GOAL_NAME_CHANGE = 'CorporationGoalNameChange';
    const TYPE_CORPORATION_LEFT = 'CorporationLeft';
    ...
    const TYPE_STRUCTURE_PAINT_PURCHASED = 'StructurePaintPurchased';
