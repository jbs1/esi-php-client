...
class GetCorporationsCorporationIdRolesHistory200Ok implements ModelInterface, ArrayAccess
{
    ...
    const NEW_ROLES_PROJECT_MANAGER = 'Project_Manager';
    ...
    const NEW_ROLES_SKILL_PLAN_MANAGER = 'Skill_Plan_Manager';
    ...
    const OLD_ROLES_PROJECT_MANAGER = 'Project_Manager';
    ...
    const OLD_ROLES_SKILL_PLAN_MANAGER = 'Skill_Plan_Manager';
