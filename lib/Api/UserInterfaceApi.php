...
class UserInterfaceApi
{
    ...
    protected function postUiAutopilotWaypointRequest($add_to_beginning, $clear_other_waypoints, $destination_id, $datasource = 'tranquility', $token = null)
    {
        ...
        if ($add_to_beginning !== null) {
            $queryParams['add_to_beginning'] = ObjectSerializer::toQueryValue($add_to_beginning, null);
        }
        // query params
        if ($clear_other_waypoints !== null) {
            $queryParams['clear_other_waypoints'] = ObjectSerializer::toQueryValue($clear_other_waypoints, null);
        }
        // query params
        if ($datasource !== null) {
        ...
        if ($destination_id !== null) {
            $queryParams['destination_id'] = ObjectSerializer::toQueryValue($destination_id, 'int64');
        }
        // query params
        if ($token !== null) {
    ...
    protected function postUiOpenwindowContractRequest($contract_id, $datasource = 'tranquility', $token = null)
    {
        ...
        // query params
        if ($contract_id !== null) {
            $queryParams['contract_id'] = ObjectSerializer::toQueryValue($contract_id, 'int32');
        }
        // query params
        if ($datasource !== null) {
            $queryParams['datasource'] = ObjectSerializer::toQueryValue($datasource, null);
    ...
    protected function postUiOpenwindowInformationRequest($target_id, $datasource = 'tranquility', $token = null)
    {
        ...
        // query params
        if ($target_id !== null) {
            $queryParams['target_id'] = ObjectSerializer::toQueryValue($target_id, 'int32');
        }
        // query params
        if ($token !== null) {
            $queryParams['token'] = ObjectSerializer::toQueryValue($token, null);
    ...
    protected function postUiOpenwindowMarketdetailsRequest($type_id, $datasource = 'tranquility', $token = null)
    {
        ...
        // query params
        if ($type_id !== null) {
            $queryParams['type_id'] = ObjectSerializer::toQueryValue($type_id, 'int32');
        }
     ...
     *
     * @param  \Swagger\Client\Model\PostUiOpenwindowNewmailNewMail $body The details of mail to create (required)
     * @param  string $datasource The server name you would like data from (optional, default to tranquility)
     * @param  string $token Access token to use if unable to set a header (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     ...
     * @return void
     */
    public function postUiOpenwindowNewmail($body, $datasource = 'tranquility', $token = null)
    {
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function postUiOpenwindowNewmailWithHttpInfo($body, $datasource = 'tranquility', $token = null)
    {
        $returnType = '';
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postUiOpenwindowNewmailAsync($body, $datasource = 'tranquility', $token = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postUiOpenwindowNewmailAsyncWithHttpInfo($body, $datasource = 'tranquility', $token = null)
    {
        $returnType = '';
        $request = $this->postUiOpenwindowNewmailRequest($body, $datasource, $token);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function postUiOpenwindowNewmailRequest($body, $datasource = 'tranquility', $token = null)
    {
